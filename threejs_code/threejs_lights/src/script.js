...
const rectAreaLight=new THREE.RectAreaLight(0xff04ff,1,10,1)
...
gui.add(pointLight,"intensity").min(-3).max(3).step(0.01).name("pointlight-intensity")
gui.add(ambientLight,"intensity").min(-3).max(3).step(0.01).name("Ambient-intensity")
gui.add(directionalLight,"intensity").min(-3).max(3).step(0.01).name("Directional-intensity")
gui.add(hemisphereLight,"intensity").min(-3).max(3).step(0.01).name("Hemisphere-intensity")
